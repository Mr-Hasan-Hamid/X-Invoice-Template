        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <nav className="flex gap-6 items-center">
             ...
             <div className="flex gap-4">
                <a href="#" className="p-2 text-slate-400 hover:text-slate-900 transition-colors"><Github size={18} /></a>
                <a href="#" className="p-2 text-slate-400 hover:text-fuchsia-600 transition-colors"><Instagram size={18} /></a>
             </div>
          </nav>
        </div>
      </header>
